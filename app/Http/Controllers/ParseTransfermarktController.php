...
class ParseTransfermarktController extends Controller
{
    public $talent;
    ...
    public function parse($id)
    {
        ...
        foreach($team_squad_urls as $url){
            ...
            $parsed_team_players_urls = $parsed_team_players_urls->map(function ($item, $key) {
                return $item->url;
            });

            $new_to_parse = collect($player_links)->diff($parsed_team_players_urls)->all();
            ...
            $this->getAndSavePlayer($new_to_parse);
        }
